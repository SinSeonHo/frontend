...
// push(뒤에 추가), unshift(앞에 추가), 인덱스(수정의 개념 기존 인덱스 값을 대체함)
fruits.push("메론");
console.log("push 후 확인 ", fruits.toString());
fruits.unshift("키위");
console.log("unshift 후 확인 ", fruits.toString());
fruits[3] = "딸기";
console.log("인덱스로 추가 후 확인 ", fruits.toString());

// splice(위치, 삭제할개수, item)
// "자전거", "자동차", "기차", "트럭", "오토바이"
array1.splice(2, 0, "킥보드");
console.log("splice 후 확인 ", array1.toString());
planet.splice(6, 1, "명왕성"); // == planet[6] = "명왕성"
console.log("splice 후 확인 ", planet.toString());
